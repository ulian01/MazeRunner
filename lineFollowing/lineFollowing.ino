...
// D1..D8 → A0..A7 (this already matches your layout)
int sensorPins[NUM_SENSORS] = {              // Which Arduino pin each sensor is connected to
  A0, A1, A2, A3, A4, A5, A6, A7             // D1 = A0, D2 = A1, ... , D8 = A7
};
...
//  - 11 & 10 = left motor
//  - 6  & 5  = right motors
const int MOTOR_A_1 = 11;                    // Left motor forward (PWM)
const int MOTOR_A_2 = 10;                    // Left motor backward
const int MOTOR_B_1 = 6;                     // Right motor forward (PWM)
...
void followLine(int position) {
    ...
    error = position - center;               // Negative: line left, positive: line right
